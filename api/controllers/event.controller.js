...
function findEvents(req, res) {
  ...
  var url = `${eventful.EVENTFUL_BASE_URL}/events/search?app_key=${eventful.EVENTFUL_API_KEY}&location=${location}&date=${date}&image_sizes=block200&page_size=40&include=popularity`;
